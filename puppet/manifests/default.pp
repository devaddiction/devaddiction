...
apache::vhost { 'devaddiction.devel':
  server_name   => 'devaddiction.devel',
  serveraliases => ['www.devaddiction.devel'],
...
mysql::grant { 'app_devaddiction':
  mysql_privileges     => 'ALL',
  mysql_db             => 'app_devaddiction',
